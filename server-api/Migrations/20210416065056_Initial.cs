        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Hash = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserData_Files_AvatarId",
                        column: x => x.AvatarId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundColor = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movies_Files_BackgroundImageId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Movies_Files_PreviewId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    MoviesId = table.Column<int>(type: "int", nullable: false),
                    UserDatasId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieUserData", x => new { x.MoviesId, x.UserDatasId });
                    table.ForeignKey(
                        name: "FK_MovieUserData_Movies_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieUserData_UserData_UserDatasId",
                        column: x => x.UserDatasId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_BackgroundImageId",
                table: "Movies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieUserData_UserDatasId",
                table: "MovieUserData",
                column: "UserDatasId");
